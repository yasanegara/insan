...
const JalsahPage: React.FC<JalsahPageProps> = ({ 
    user, 
    invitations = [], 
    onAcceptInvitation, 
    onRejectInvitation 
  ...
  // If user has no jalsah, check invitations
      ...
      return (
        <div className="pb-24 pt-4 px-4 space-y-6">
            <div className="text-center mb-6">
                <h2 className="text-2xl font-bold text-slate-800">Jalsah Virtual</h2>
            ...
            {myInvitations.length > 0 ? (
                ...
                <div className="bg-slate-50 rounded-xl p-8 text-center border border-slate-100 border-dashed">
                    ...
                    <h3 className="font-bold text-slate-700">Belum Ada Jalsah</h3>
                    <p className="text-sm text-slate-500 mt-2">
                        Anda belum tergabung dalam jalsah manapun. 
  ...
  return (
    <div className="pb-24 pt-4 px-4 space-y-6">
      <div className="text-center mb-6">
        <h2 className="text-2xl font-bold text-slate-800">Jalsah Al-Fatih</h2>
